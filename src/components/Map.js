...
const Map = ({ setProducts, open }) => {
  const setDisplayed = async (e) => {
    let selectedProducts = [];
    let selectedProdSeries = "";
    let area = e.target.getAttribute("name");
    switch (area) {
      case "Warmian-Masurian":
      case "Pomeranian":
      case "Lower Silesian":
      case "West Pomeranian":
      ...
      case "Opole":
        ...
        break;
      case "Świętokrzyskie":
      case "Kuyavian-Pomeranian":
      case "Lesser Poland":
      case "Lubusz":
        selectedProdSeries = "fourth";
        break;
      default:
        selectedProdSeries = "first";
    }
    ...
    await setProducts(selectedProducts);
